...
//                updateUI();
                ...
                Intent intent = new Intent(PostListFragment.this,PostActivity.class);
            ...
            case R.id.logout:
                ...
                Intent intent2 = new Intent(PostListFragment.this,Login.class);
    ...
    {
        adapter = new BlogViewPager(getSupportFragmentManager());
